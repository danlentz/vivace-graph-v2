...
(def (generic ed) summarize-btree-contents (btree &key print-depth search-depth dump recurse))
  
(def method summarize-btree-contents ((btree btree) &key (print-depth 100) (search-depth nil)
